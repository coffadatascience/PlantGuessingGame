...
,
        ...
        public static List<Plant> GetAllPlants(IEnumerable<Phylum> phyla)
        {
            ...
            new Plant
            {
                ...
                AlternativeNames = "Sacred bamboo, Chinese sacred bamboo",
                Family = "Berberidaceae",
                Genus = "Nandina",
                Species = "domestica",
                ...
                Etymology = "De geslachtsnaam 'Nandina' komt uit het Japans, waar de plant 'Nanten' wordt genoemd en wordt geassocieerd met het vermogen om problemen te verdrijven.",ImagePath = diskLocationImages + "HeavenlyBamboo_Nandina_domestica_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                Etymology = "De naam 'Carpinus', het geslacht van de Haagbeuk, is Latijnse oorsprong en mogelijk afgeleid van een pre-Latijnse wortel die ‘hard hout’ betekent; 'betulus' verwijst naar een oude naam voor beukachtige bomen.",
                ImagePath = diskLocationImages + "Haagbeuk_Carpinus_betulus_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
            ...
            new Plant
            {
                ...
                AlternativeNames = "European beech, Common beech",
                Family = "Fagaceae",
                Genus = "Fagus",
                Species = "sylvatica",
                ...
                Etymology = "De geslachtsnaam 'Fagus' is Latijn voor beuk, een boomsoort die al sinds de oudheid bekend is; 'sylvatica' betekent 'van het bos' in het Latijn.",ImagePath = diskLocationImages + "Beukenhaag_Fagus_sylvatica_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                AlternativeNames = "Bigleaf hydrangea, Mophead hydrangea, French hydrangea",
                Family = "Hydrangeaceae",
                Genus = "Hydrangea",
                Species = "macrophylla",
                ...
                Etymology = "De naam 'Hydrangea' is afgeleid van het Grieks: 'hydor' (water) en 'angeion' (container), verwijzend naar de waterbehoefte van de plant; 'paniculata' betreft de pluimvormige bloeiwijze; 'Limelight' is een cultivarnaam.",
                ImagePath = diskLocationImages + "HydrangeaMacrophylla_Hydrangea_macrophylla_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
            ...
            new Plant
            {
                ...
                AlternativeNames = "London plane, Plane tree, Hybrid plane",
                Family = "Platanaceae",
                Genus = "Platanus",
                Species = "acerifolia",
                ...
                Etymology = "De geslachtsnaam 'Platanus' stamt uit het Grieks en betekent 'breedbladig', verwijzend naar de grote bladeren; 'acerifolia' betekent 'esdoornachtig blad'.",ImagePath = diskLocationImages + "Plataan_Platanus_hispanica_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                Etymology = "De naam 'Malus' is Latijn voor appelboom; 'domestica' verwijst naar de gedomesticeerde vorm, gekweekt voor zijn vruchten.",ImagePath = diskLocationImages + "Malus_domestica_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = true,
            ...
            new Plant
            {
                ...
                LocalName = "Els",
                CommonName = "Els",
                AlternativeNames = "Black alder, Common alder, European alder",
                Family = "Betulaceae",
                Genus = "Alnus",
                Species = "glutinosa",
                ...
                Etymology = "De geslachtsnaam 'Alnus' is een oude Latijnse naam voor els; 'glutinosa' verwijst naar de kleverige of licht kleverige eigenschappen van de takken en knoppen.",ImagePath = diskLocationImages + "ZwarteEls_Alnus_glutinosa_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Tulp",
                CommonName = "Tulp",
                AlternativeNames = "Garden tulip, Dutch tulip",
                Family = "Liliaceae",
                Genus = "Tulipa",
                Species = "gesneriana",
                ...
                Etymology = "De naam 'Tulipa' is afgeleid van het Perzische woord 'dulband' dat 'turbaan' betekent, vanwege de bloembuisvorm; 'gesneriana' eert Conrad Gessner, een Zwitserse botanicus.",ImagePath = diskLocationImages + "Tulp_Tulipa_sp_Base01.png",
                PlantType = PlantType.Bulb,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Narcis",
                CommonName = "Narcis",
                AlternativeNames = "Wild daffodil, Lent lily, Trumpet daffodil",
                Family = "Amaryllidaceae",
                Genus = "Narcissus",
                Species = "pseudonarcissus",
                ...
                Etymology = "De geslachtsnaam 'Narcissus' komt van een Griekse mythe over Narcissus, een jongeman die verliefd werd op zijn eigen spiegelbeeld; 'pseudonarcissus' betekent 'nep-narcis', een specifieke soortnaam.",ImagePath = diskLocationImages + "Narcis_Narcissus_sp_Base01.png",
                PlantType = PlantType.Bulb,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Zomereik",
                CommonName = "Zomereik",
                AlternativeNames = "English oak, Pedunculate oak, Common oak",
                Family = "Fagaceae",
                Genus = "Quercus",
                Species = "robur",
                ...
                Etymology = "De geslachtsnaam 'Quercus' is Latijn voor eik; 'robur' betekent 'sterkte' of ‘hardhout’, verwijzend naar de taaie houtsoort.",ImagePath = diskLocationImages + "Zomereik_Quercus_robur_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Aardbei",
                CommonName = "Aardbei",
                AlternativeNames = "Garden strawberry, Strawberry",
                Family = "Rosaceae",
                Genus = "Fragaria",
                Species = "ananassa",
                ...
                Etymology = "De naam 'Fragaria' is afkomstig van het Latijnse woord voor aardbei; 'ananassa' verwijst naar de ananassmaak die sommige aardbeienrassen hebben ontwikkeld.",ImagePath = diskLocationImages + "Aardbei_Fragaria_ananassa_Base01.png",
                PlantType = PlantType.Herb,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = true,
            ...
            new Plant
            {
                ...
                Etymology = "De geslachtsnaam 'Cortaderia' is genoemd naar de Argentijnse botanist Cortaderas; 'selloana' verwijst naar de ontdekker Sello. De Engelse naam Pampasgras verwijst naar het Pampa-gebied in Zuid-Amerika waar de plant vandaan komt.",ImagePath = diskLocationImages + "Pampasgras_Cortaderia_selloana_Base01.png",
                PlantType = PlantType.Grass,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                AlternativeNames = "Fountain grass, Lamp cleaner grass",
                Family = "Poaceae",
                Genus = "Pennisetum",
                Species = "alopecuroides",
                ...
                Etymology = "De naam 'Pennisetum' komt van Latijnse woorden 'penna' (veer) en 'seta' (borstel), verwijzend naar de pluimachtige bloeiwijzen; 'alopecuroides' betekent 'lijkt op vosstaart', refererend aan de vorm van de aren.",ImagePath = diskLocationImages + "Lampenpoetsersgras_Pennisetum_alopecuroides_Base01.png",
                PlantType = PlantType.Grass,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Cotoneaster",
                CommonName = "Cotoneaster",
                AlternativeNames = "Rock cotoneaster, Wall cotoneaster",
                Family = "Rosaceae",
                Genus = "Cotoneaster",
                Species = "horizontalis",
                ...
                Etymology = "De geslachtsnaam 'Cotoneaster' is afgeleid van het Latijnse 'cotoneum' (kweepeer) en het achtervoegsel '-aster' (lijkend op), verwijzend naar de vruchten die op kweeperen lijken; 'horizontalis' betekent 'horizontaal groeiend'.",ImagePath = diskLocationImages + "Cotoneaster_Cotoneaster_sp_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                Etymology = "De naam 'Weigela' is genoemd naar de Duitse botanicus Christian Ehrenfried Weigel; 'florida' betekent 'bloeiend' in het Latijn.",ImagePath = diskLocationImages + "WeigelaFlorida_Weigela_florida_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                AlternativeNames = "Fiddle-leaf fig, Violin fig",
                Family = "Moraceae",
                Genus = "Ficus",
                Species = "lyrata",
                ...
                Etymology = "De geslachtsnaam 'Ficus' is Latijn voor vijg, verwijzend naar de nourriture en vrucht van de vijgenboom; 'lyrata' betekent 'lyratisch' of 'gelijkend op een lier', verwijzend naar de bladvorm.",ImagePath = diskLocationImages + "Vioolbladplant_Ficus_lyrata_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Howea forsteriana",
                CommonName = "Kentia palm",
                AlternativeNames = "Kentia palm, Paradise palm",
                Family = "Arecaceae",
                Genus = "Howea",
                Species = "forsteriana",
                ...
                Etymology = "De naam 'Howea' is genoemd naar de Britse botanicus John How; 'forsteriana' eert naturalist Johann Reinhold Forster, beiden verbonden aan Lord Howe eiland.",ImagePath = diskLocationImages + "KentiaPalm_Howea_forsteriana_Base01.png",
                PlantType = PlantType.Palm,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                AlternativeNames = "Corn plant, Dragon tree, Striped dracaena",
                Family = "Asparagaceae",
                Genus = "Dracaena",
                Species = "fragrans",
                ...
                Etymology = "De geslachtsnaam 'Dracaena' komt van het Griekse 'drakaina' (draak), vanwege de rode hars die uit sommige soorten komt; 'fragrans' betekent 'geurig'.",
                ImagePath = diskLocationImages + "Drakenbloedboom_Dracaena_fragrans_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
            ...
            new Plant
            {
                ...
                AlternativeNames = "Box honeysuckle, Chinese honeysuckle",
                Family = "Caprifoliaceae",
                Genus = "Lonicera",
                Species = "nitida",
                ...
                Etymology = "De naam 'Lonicera' is vernoemd naar de Duitse arts en botanicus Adam Lonicer; 'nitida' betekent 'glanzend', verwijzend naar het glanzende blad.",ImagePath = diskLocationImages + "Lonicera_Lonicera_sp_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                AlternativeNames = "Catnip, Catmint",
                Family = "Lamiaceae",
                Genus = "Nepeta",
                Species = "cataria",
                ...
                Etymology = "De geslachtsnaam 'Nepeta' is genoemd naar de Romeinse stad Neapolis; 'cataria' verwijst naar katten, omdat het plant een aantrekkingskracht op hen heeft.",            ImagePath = diskLocationImages + "GrijsKattenkruid_Nepeta_x_faassenii_Base01.png",
                PlantType = PlantType.Herb,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = true,
            ...
            new Plant
            {
                ...
                LocalName = "Lavendel",
                CommonName = "Lavender",
                AlternativeNames = "English lavender, True lavender",
                Family = "Lamiaceae",
                Genus = "Lavandula",
                Species = "angustifolia",
                ...
                Etymology = "De naam 'Lavandula' is afgeleid van het Latijnse 'lavare', wat 'wassen' betekent, vanwege het gebruik in baden; 'angustifolia' betekent 'smalbladig'.",ImagePath = diskLocationImages + "EchteLavendel_Lavandula_angustifolia_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = true,
            ...
            new Plant
            {
                ...
                LocalName = "Pioenroos",
                CommonName = "Peony",
                AlternativeNames = "Chinese peony, Garden peony",
                Family = "Paeoniaceae",
                Genus = "Paeonia",
                Species = "lactiflora",
                ...
                Etymology = "De geslachtsnaam 'Paeonia' is afkomstig van een student van Asclepius, god van geneeskunde; 'lactiflora' betekent 'melkachtig bloemig', verwijzend naar de kleur.",ImagePath = diskLocationImages + "Pioenroos_Paeonia_lactiflora_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Gele Papaver",
                CommonName = "Iceland Poppy",
                AlternativeNames = "Iceland poppy, Arctic poppy",
                Family = "Papaveraceae",
                Genus = "Papaver",
                Species = "nudicaule",
                ...
                Etymology = "De naam 'Papaver' is Latijn voor papaver of klaproos; 'nudicaule' betekent 'bloemsteel naakt', verwijzend naar de bladloze bloemenstengels.",ImagePath = diskLocationImages + "Gele_klaproos_Papaver_cambrica_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Embryophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                CommonName = "Lesser Periwinkle",
                AlternativeNames = "Lesser periwinkle, Common periwinkle, Dwarf periwinkle",
                Family = "Apocynaceae",
                Genus = "Vinca",
                Species = "minor",
                ...
                Etymology = "De geslachtsnaam 'Vinca' komt waarschijnlijk van het Latijnse 'vincire' (binden), verwijzend naar de kruipende groeiwijze; 'minor' betekent 'kleiner', verwijzend naar de kleinere soort.",ImagePath = diskLocationImages + "KleineMaagdenpalm_Vinca_minor_Base01.png",
                PlantType = PlantType.GroundCover,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Blue Gum",
                CommonName = "Eucalyptus",
                AlternativeNames = "Tasmanian blue gum, Blue gum eucalyptus",
                Family = "Myrtaceae",
                Genus = "Eucalyptus",
                Species = "globulus",
                ...
                Etymology = "De naam 'Eucalyptus' komt uit het Grieks: 'eu' (goed) en 'kalyptos' (bedekt), verwijzend naar de bedekte bloemknoppen; 'globulus' betekent 'kleine bol', naar de vorm van bepaalde delen.",ImagePath = diskLocationImages + "EucalyptusBoom_Eucalyptus_gunnii_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
...
,
               ...
               new Plant
                {
                    ...
                    LocalName = "Photinia 'Red Robin'",
                    CommonName = "Photinia",
                    AlternativeNames = "Red Robin photinia",
                    Family = "Rosaceae",
                    Genus = "Photinia",
                    Species = "× fraseri",
                    Description = "An attractive evergreen shrub prized for its bright red new foliage that matures to glossy dark green. Produces small white flower clusters in late spring, though flowering is often secondary to its foliage appeal. Commonly used as a hedge or feature plant. Tolerates pruning well and thrives in full sun to partial shade.",
                    Etymology = "De geslachtsnaam 'Photinia' is genoemd naar de Griekse term 'photeinos' (glanzend), vanwege glanzend blad; '× fraseri' is een cultivar-naam ter ere van een kweker.",
                    ImagePath = diskLocationImages + "Photinia_Photinia_fraseri_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
               ...
               new Plant
                {
                    ...
                    LocalName = "Cherry Laurel",
                    CommonName = "Prunus laurocerasus",
                    AlternativeNames = "Common laurel, English laurel, Wild cherry laurel",
                    Family = "Rosaceae",
                    Genus = "Prunus",
                    Species = "laurocerasus",
                    Description = "A fast-growing, dense evergreen shrub or small tree with large, glossy dark green leaves. Produces upright clusters of small white flowers in spring, followed by small black berries. Commonly used for hedging and screening due to its dense foliage. Tolerant of shade and pruning, and adaptable to various soil types.",
                    Etymology = "De naam 'Prunus' is Latijn voor pruim/bes; 'laurocerasus' verwijst naar de laurierkers, waarbij 'lauro-' slaat op laurierblad en 'cerasus' op kers.",ImagePath = diskLocationImages + "PrunusLaurocerasus_Prunus_laurocerasus_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
               ...
               new Plant
            {
                ...
                LocalName = "Male Fern 'Linearis Polydactyla'",
                CommonName = "Male Fern",
                AlternativeNames = "Male fern",
                Family = "Dryopteridaceae",
                Genus = "Dryopteris",
                Species = "filix-mas",
                Description = "A deciduous fern forming large, shuttlecock-like clumps of erect to arching, mid-green fronds. The fronds are finely divided, giving it a delicate and airy appearance. Ideal for shaded gardens and woodland settings.",
                Etymology = "De geslachtsnaam 'Dryopteris' betekent 'bosvaren' in het Grieks ('drys' bos, 'pteris' varen); 'filix-mas' betekent 'manlijke varen'.",ImagePath = diskLocationImages + "Mannetjesvaren_Dryopteris_flix-mas_Base01.png",
                PlantType = PlantType.Fern,
                PlantClassification = PlantClassification.Pteridophytes,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Polypodiophyta"),
                IsEatable = false,
               ...
               new Plant
                {
                    ...
                    LocalName = "Snowberry",
                    CommonName = "Chenault Coralberry",
                    AlternativeNames = "Chenault coralberry, Snowberry",
                    Family = "Caprifoliaceae",
                    Genus = "Symphoricarpos",
                    Species = "× chenaultii",
                    Description = "A dense, deciduous shrub with arching branches and small oval leaves. Produces small pink flowers in summer followed by clusters of white or pale pink berries in autumn, which persist into winter. Commonly used for groundcover, hedging, or wildlife gardens. Tolerates poor soils and urban conditions well.",
                    Etymology = "De naam 'Symphoricarpos' komt uit het Grieks en betekent 'drager van bessen'; '× chenaultii' is een hybride cultivarnaam.",ImagePath = diskLocationImages + "Symphoricarpos_orbiculatus_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
               ...
               new Plant
                {
                    ...
                    LocalName = "Coconut Palm",
                    CommonName = "Coconut Tree",
                    AlternativeNames = "Coconut tree",
                    Family = "Arecaceae",
                    Genus = "Cocos",
                    Species = "nucifera",
                    Description = "A tall, tropical palm tree with a slender, ringed trunk and large, feathery fronds. It produces coconuts, which are used for food, oil, fiber, and water. The coconut palm thrives in sandy, well-drained soils in coastal areas and requires full sun and high humidity.",
                    Etymology = "De geslachtsnaam 'Cocos' verwijst naar kokosnoten en is van onbekende oorsprong, mogelijk Portugees of Spaans; 'nucifera' betekent 'noten dragend'.",ImagePath = diskLocationImages + "Kokospalm_Cocos_nucifera_Base01.png",
                    PlantType = PlantType.Tree,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = true,
              ...
              new Plant
                {
                    ...
                    LocalName = "Dieffenbachia amoena",
                    CommonName = "Dumb Cane",
                    AlternativeNames = "Dumb cane",
                    Family = "Araceae",
                    Genus = "Dieffenbachia",
                    Species = "amoena",
                    Description = "A tropical evergreen perennial with large, broad leaves marked with creamy white or light green patterns. It is a popular indoor plant due to its attractive foliage and tolerance of low light conditions. Requires warm, humid environments and regular watering.",
                    Etymology = "De naam 'Dieffenbachia' is genoemd naar Duitse arts Joseph Dieffenbach; 'amoena' betekent ‘aangenaam’ of ‘mooi’ in het Latijn.",ImagePath = diskLocationImages + "GrootbladigeDieffenbachia_Dieffenbachia_amoena_Base01.png",
                    PlantType = PlantType.Houseplant,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
              ...
              new Plant
                {
                    ...
                    LocalName = "Yellow Horned Poppy",
                    CommonName = "Horned Poppy",
                    AlternativeNames = "Horned poppy",
                    Family = "Papaveraceae",
                    Genus = "Glaucium",
                    Species = "flavum",
                    Description = "A hardy perennial coastal plant with gray-green, lobed leaves and large, bright yellow cup-shaped flowers. It produces distinctive long, curved seed pods resembling horns. Thrives in sandy, well-drained soils, often found on dunes and seaside cliffs.",
                    Etymology = "De geslachtsnaam 'Glaucium' is afgeleid van het Griekse woord ‘glaukos’, wat ‘metallic-grijs/blauw-groen’ betekent, met betrekking tot het blad; 'flavum' betekent 'geel'.",ImagePath = diskLocationImages + "Gele_klaproos_Papaver_cambrica_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                ...
                new Plant
                {
                    ...
                    LocalName = "Paeonia edulis",
                    CommonName = "Edulis Peony",
                    AlternativeNames = "Edulis peony, Chinese tree peony",
                    Family = "Paeoniaceae",
                    Genus = "Paeonia",
                    Species = "edulis",
                    Description = "A deciduous perennial peony native to China, known for its large, showy flowers that range in colors from white to pink. Prefers well-drained soil and a sunny to partially shaded location. Blooms in late spring to early summer.",
                    Etymology = "De geslachtsnaam 'Paeonia' is afkomstig van een student van Asclepius, god van geneeskunde; 'edulis' betekent 'eetbaar' in het Latijn.",ImagePath = diskLocationImages + "Pioenroos_Paeonia_edulis_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                ...
                new Plant
                {
                    ...
                    LocalName = "Spathiphyllum wallisii",
                    CommonName = "Peace Lily",
                    AlternativeNames = "Peace lily",
                    Family = "Araceae",
                    Genus = "Spathiphyllum",
                    Species = "wallisii",
                    Description = "A popular evergreen perennial valued for its lush green foliage and striking white spathes. Native to tropical regions of the Americas and Southeast Asia. Thrives as a houseplant and is known for its air-purifying qualities.",
                    Etymology = "De geslachtsnaam 'Spathiphyllum' komt van het Grieks 'spath' (blad) en 'phyllon' (blad), verwijzend naar de schutbladeren; 'wallisii' eert botanicus Gustav Wallis.",ImagePath = diskLocationImages + "PeaceLily_Spathiphyllum_wallisii_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                ...
                new Plant
                {
                    ...
                    LocalName = "Stargazer Lily",
                    CommonName = "Stargazer Lily",
                    AlternativeNames = "Stargazer lily",
                    Family = "Liliaceae",
                    Genus = "Lilium",
                    Species = "'Stargazer'",
                    Description = "A vibrant, fragrant oriental lily cultivar featuring large, upward-facing pink flowers with white edges and dark spots. Blooms in mid to late summer and is widely grown for cut flowers and garden display. Prefers well-drained soil and full sun to partial shade.",
                    Etymology = "De naam 'Lilium' is Latijn voor lelie; 'Stargazer' is een cultivarnaam die verwijst naar de omhoog gerichte bloemen.",ImagePath = diskLocationImages + "StargazerLelie_Lilium_orientalis_Stargazer_Base01.png",
                    PlantType = PlantType.Bulb,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
               ...
               new Plant
                {
                    ...
                    LocalName = "Clematis armandii",
                    CommonName = "Evergreen Clematis",
                    AlternativeNames = "Evergreen clematis, Armand clematis",
                    Family = "Ranunculaceae",
                    Genus = "Clematis",
                    Species = "armandii",
                    Description = "An evergreen climbing vine with leathery dark green leaves and fragrant white flowers that bloom in early spring. It thrives in well-drained soil with full sun to partial shade and is often used to cover walls, fences, or trellises.",
                    Etymology = "De geslachtsnaam 'Clematis' is Grieks voor een klimplant; 'armandii' is genoemd naar de Franse botanicus Armand.",ImagePath = diskLocationImages + "Clematis_Clematis_sp_Base01.png",
                    PlantType = PlantType.Climber,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
...
,
               ...
               new Plant
                {
                    ...
                    LocalName = "Lithodora diffusa",
                    CommonName = "Lithodora, Creeping Gromwell",
                    AlternativeNames = "Lithodora, Creeping Gromwell",
                    Family = "Boraginaceae",
                    Genus = "Lithodora",
                    Species = "diffusa",
                    Description = "A prostrate, multi-branched evergreen ground cover native to southwestern Europe and the Mediterranean. Known for its intense blue, star-shaped flowers and dense, hairy, dark green foliage. Ideal for rock gardens, slopes, and as a ground cover.",
                    Etymology = "De naam 'Lithodora' komt van het Grieks 'lithos' (steen) en 'dora' (gift), verwijzend naar de rotsige habitat; 'diffusa' betekent 'uitgespreid'.",
                    ImagePath = diskLocationImages + "Lithodora_diffusa_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
               ...
               new Plant
                {
                    ...
                    LocalName = "Salix integra",
                    CommonName = "Japanese Willow, Hakuro Nishiki",
                    AlternativeNames = "Hakuro nishiki, Japanese willow",
                    Family = "Salicaceae",
                    Genus = "Salix",
                    Species = "integra",
                    Description = "A deciduous shrub or small tree prized for its vibrant, variegated foliage and attractive habit. Native to Japan and Korea. Often used as a specimen plant or in mixed borders for its colorful leaves and graceful form.",
                    Etymology = "De geslachtsnaam 'Salix' is Latijn voor wilg; 'integra' betekent 'ongedeeld' of 'compleet', verwijzend naar het blad.",ImagePath = diskLocationImages + "Salix_integra_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
               ...
               // Vicia villosa
                new Plant
                {
                    ...
                    LocalName = "Vicia villosa",
                    CommonName = "Hairy Vetch",
                    AlternativeNames = "Hairy vetch",
                    Family = "Fabaceae",
                    Genus = "Vicia",
                    Species = "villosa",
                    Description = "A vigorous annual or biennial legume valued as a cover crop for its ability to fix nitrogen, improve soil structure, and suppress weeds. Recognized by its trailing, climbing habit and hairy stems and leaves. Produces purple to violet pea-like flowers.",
                    Etymology = "De naam 'Vicia' komt uit het Latijn; 'villosa' betekent 'behaard'.",
                    ImagePath = diskLocationImages + "Vicia_villosa_Base01.png",
                    PlantType = PlantType.Herb, // Annual/biennial legume
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
...
,
                ...
                new Plant
                {
                    ...
                    LocalName = "Heuchera 'Mulberry'",
                    CommonName = "Purperklokje Mulberry",
                    AlternativeNames = "Mulberry coral bells, Purple heuchera",
                    Family = "Saxifragaceae",
                    Genus = "Heuchera",
                    Species = "Mulberry", // Cultivar
                    Description = "Compacte, halfwintergroene vaste plant met opvallend glanzend paars blad en donkerpaarse nerven. In de zomer verschijnen op donkere stelen kleine, lichtroze bloemen. Ideaal voor borders, rotstuinen en potten.",
                    Etymology = "De geslachtsnaam 'Heuchera' is genoemd naar J. E. Heucher, een 18e-eeuwse arts; 'Mulberry' is een cultivarnaam vanwege de bladkleur.",
                    ImagePath = diskLocationImages + "Heuchera_Mulberry_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Sedum 'Crystal Pink'",
                    CommonName = "Crystal Pink Stonecrop",
                    AlternativeNames = "Crystal pink stonecrop",
                    Family = "Crassulaceae",
                    Genus = "Sedum",
                    Species = "spectabile", // Cultivar: 'Crystal Pink'
                    Description = "A low-growing, clump-forming, deciduous perennial with thick, fleshy, bright blue-green leaves. In late summer and fall, it produces large clusters of star-shaped icy pink flowers on sturdy stems. Drought-tolerant and highly attractive to butterflies, it is ideal for borders, rock gardens, and containers.",
                    Etymology = "De naam 'Sedum' is Latijn voor vetplant; 'spectabile' betekent prachtig of opvallend; 'Crystal Pink' is een cultivarnaam.",
                    ImagePath = diskLocationImages + "Sedum_CrystalPink_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Erica carnea",
                    CommonName = "Winterheide, Schneeheide",
                    AlternativeNames = "Winter heath, Winter heather",
                    Family = "Ericaceae",
                    Genus = "Erica",
                    Species = "carnea",
                    Description = "Laagblijvende, wintergroene heester met naaldachtig blad en klokvormige bloemen. Bloeit van de winter tot het vroege voorjaar in kleuren van wit tot roze en paars. Geschikt als bodembedekker, voor rotstuinen en wintertuinen.",
                    Etymology = "De geslachtsnaam 'Erica' is afgeleid van het Griekse woord voor heide; 'carnea' betekent 'blozend' of 'rozeachtig'.",
                    ImagePath = diskLocationImages + "Erica_carnea_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Carex morrowii",
                    CommonName = "Japanse zegge",
                    AlternativeNames = "Japanese sedge, Morrow's sedge",
                    Family = "Cyperaceae",
                    Genus = "Carex",
                    Species = "morrowii",
                    Description = "Wintergroene, polvormende siergrasachtige plant met smal, overhangend blad. Populair vanwege het decoratieve, vaak bontgevlekte blad. Geschikt als bodembedekker, voor schaduwrijke borders en onderbeplanting.",
                    Etymology = "De geslachtsnaam 'Carex' betekent zegge; 'morrowii' verwijst naar botanicus Morrow.",
                    ImagePath = diskLocationImages + "Carex_morrowii_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Campanula poscharskyana",
                    CommonName = "Servisch klokje",
                    AlternativeNames = "Serbian bellflower, Serbian campanula",
                    Family = "Campanulaceae",
                    Genus = "Campanula",
                    Species = "poscharskyana",
                    Description = "Laagblijvende, kruipende vaste plant met stervormige paarsblauwe bloemen. Ideaal als bodembedekker, voor rotstuinen, muurtjes of randen. Bloeit langdurig in de zomer en is zeer onderhoudsarm.",
                ...
                new Plant
                {
                    ...
                    LocalName = "Campanula garganica",
                    CommonName = "Gargano klokje",
                    AlternativeNames = "Gargano bellflower",
                    Family = "Campanulaceae",
                    Genus = "Campanula",
                    Species = "garganica",
                    Description = "Laagblijvende, bodembedekkende vaste plant met stervormige, lichtblauwe tot violetblauwe bloemen aan kruipende stengels. Ideaal voor rotstuinen, randen en potten. Bloeit rijk in de zomer en trekt bijen en vlinders aan.",
                    Etymology = "De geslachtsnaam 'Campanula' betekent 'klein klokje' in het Latijn, verwijzend naar de klokvormige bloemen; 'garganica' verwijst naar de Gargano regio in Italië.",
                    ImagePath = diskLocationImages + "Campanula_garganica_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Fargesia rufa",
                    CommonName = "Dragon Head Bamboo, Niet-woekerende bamboe",
                    AlternativeNames = "Dragon head bamboo, Clumping bamboo",
                    Family = "Poaceae",
                    Genus = "Fargesia",
                    Species = "rufa",
                    Description = "Compacte, niet-woekerende bamboe met sierlijk, frisgroen blad en opgaande, licht overhangende stengels. Ideaal als haag, solitair of in pot. Zeer winterhard, snelgroeiend en bestand tegen ziekten. Geschikt voor zon, halfschaduw en schaduw.",
                    Etymology = "De geslachtsnaam 'Fargesia' is genoemd naar botanist Alexander Farges; 'rufa' betekent roodachtig in het Latijn.",
                    ImagePath = diskLocationImages + "Fargesia_rufa_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Digitalis purpurea",
                    CommonName = "Vingerhoedskruid, Foxglove",
                    AlternativeNames = "Foxglove",
                    Family = "Plantaginaceae",
                    Genus = "Digitalis",
                    Species = "purpurea",
                    Description = "Tweejarige of kortlevende vaste plant met een bladrozet in het eerste jaar en een hoge, opgaande bloeistengel in het tweede jaar. De buisvormige bloemen zijn meestal paars, maar kunnen ook roze, wit of geel zijn, vaak met opvallende vlekken aan de binnenzijde. Bekend als sierplant én als bron van de hartmedicatie digoxine. Alle delen zijn giftig.",
                    Etymology = "De geslachtsnaam 'Digitalis' is afgeleid van het Latijnse 'digitus' (vinger), vanwege de vingervorm van de bloemen; 'purpurea' betekent paars.",
                    ImagePath = diskLocationImages + "Digitalis_purpurea_Base01.png",
                    PlantType = PlantType.Biennial, // Of Perennial voor sommige cultivars
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Elaeagnus × ebbingei",
                    CommonName = "Olijfwilg, Ebbing’s silverberry",
                    AlternativeNames = "Ebbing’s silverberry, Olijfwilg",
                    Family = "Elaeagnaceae",
                    Genus = "Elaeagnus",
                    Species = "ebbingei",
                    Description = "Sterke, snelgroeiende, wintergroene struik of haagplant met glanzend donkergroen blad en zilvergrijze onderzijde. In het najaar verschijnen sterk geurende crèmekleurige bloemen, gevolgd door oranje tot roodbruine eetbare bessen in het voorjaar. Zeer geschikt voor hagen, windsingels en kusttuinen vanwege de hoge tolerantie voor wind, zout en arme grond.",
                    Etymology = "De geslachtsnaam 'Elaeagnus' komt van het Griekse 'elaia' (olijf) en 'agunos' (waardig), vanwege de olijfachtige bladeren; 'ebbingei' eert botanicus Ebbinge.",
                    ImagePath = diskLocationImages + "Elaeagnus_ebbingei_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Sedum oreganum",
                    CommonName = "Oregon stonecrop",
                    AlternativeNames = "Oregon stonecrop",
                    Family = "Crassulaceae",
                    Genus = "Sedum",
                    Species = "oreganum",
                    Description = "Laaggroeiende, winterharde vetplant afkomstig uit het westen van Noord-Amerika. Vormt dichte matten met kleine, vlezige, groene bladeren en gele bloemen in de zomer. Ideaal als bodembedekker of in rotstuinen.",
                    Etymology = "De geslachtsnaam 'Sedum' is Latijn voor vetplant; 'oreganum' verwijst naar Oregon, de regio van herkomst.",
                    ImagePath = diskLocationImages + "Sedum_oreganum_Base01.png",
                    PlantType = PlantType.Succulent,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Sedum palmeri",
                    CommonName = "Palmer’s stonecrop",
                    AlternativeNames = "Palmer’s stonecrop",
                    Family = "Crassulaceae",
                    Genus = "Sedum",
                    Species = "palmeri",
                    Description = "Sierlijke, semi-wintergroene vetplant met lichtgroene, rozetvormige bladeren en gele bloemen in het vroege voorjaar. Geschikt voor potten, rotstuinen en als kamerplant in koudere klimaten.",
                    Etymology = "De naam 'Sedum' is Latijn; 'palmeri' is vernoemd naar de botanicus Palmer.",
                    ImagePath = diskLocationImages + "Sedum_palmeri_Base01.png",
                    PlantType = PlantType.Succulent,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Sedum sarmentosum",
                    CommonName = "Stringy stonecrop",
                    AlternativeNames = "Stringy stonecrop",
                    Family = "Crassulaceae",
                    Genus = "Sedum",
                    Species = "sarmentosum",
                    Description = "Sterk groeiende, bodembedekkende vetplant met dunne, liggende stengels en heldergele bloemen in de zomer. Zeer geschikt voor groene daken, rotstuinen en als bodembedekker.",
                    Etymology = "De geslachtsnaam 'Sedum' betekent vetplant; 'sarmentosum' betekent 'uitlopend' of 'rankend'.",
                    ImagePath = diskLocationImages + "Sedum_sarmentosum_Base01.png",
                    PlantType = PlantType.Succulent,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Humulus japonicus",
                    CommonName = "Japanese hop",
                    AlternativeNames = "Hardy fuchsia, Magellan fuchsia, Lady's eardrops",
                    Family = "Cannabaceae",
                    Genus = "Humulus",
                    Species = "japonicus",
                    Description = "Krachtig groeiende, eenjarige klimplant met ruwe stengels en diep ingesneden, handvormige bladeren. Wordt soms als sierplant gebruikt, maar kan invasief zijn. Bloeit met kleine, groenachtige bloemen in de zomer.",
                    Etymology = "De geslachtsnaam 'Humulus' is Latijn voor hopplant; 'japonicus' betekent 'uit Japan'.",
                    ImagePath = diskLocationImages + "Humulus_japonicus_Base01.png",
                    PlantType = PlantType.Climber,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    Description =
                        "Sterk groeiende, bladverliezende struik met sierlijk overhangende takken. Heeft smalle, groene bladeren met gezaagde rand en bloeit langdurig met talrijke, opvallende, langwerpige rood-paarse bloemen die hangend aan de stengels verschijnen van de vroege zomer tot aan de eerste nachtvorst. Aantrekkelijk voor bijen en kolibries. Zeer winterhard voor een Fuchsia.",
                    Etymology = "De geslachtsnaam 'Fuchsia' is genoemd naar de Duitse botanicus Leonhart Fuchs; 'magellanica' verwijst naar het Magellaangebied.",
                    ImagePath = diskLocationImages + "Fuchsia_magellanica_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Callistemon citrinus",
                    CommonName = "Crimson Bottlebrush",
                    AlternativeNames = "Crimson bottlebrush, Lemon bottlebrush, Red bottlebrush",
                    Family = "Myrtaceae",
                    Genus = "Callistemon",
                    Species = "citrinus",
                    Description = "Decoratieve, groenblijvende struik met lancetvormige, aromatische bladeren en opvallende felrode, borstelvormige bloeiwijzen die verschijnen van het late voorjaar tot de nazomer. Bladeren verspreiden een citroengeur bij kneuzen. Wordt vaak als kuipplant gehouden in Nederland vanwege beperkte winterhardheid.",
                    Etymology = "De geslachtsnaam 'Callistemon' betekent 'mooie kam' in het Grieks, verwijzend naar de borstelachtige bloemen; 'citrinus' betekent 'citroenachtig'.",
                    ImagePath = diskLocationImages + "Callistemon_citrinus_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Nerium oleander",
                    CommonName = "Oleander",
                    AlternativeNames = "Oleander, Rosebay, Common oleander",
                    Family = "Apocynaceae",
                    Genus = "Nerium",
                    Species = "oleander",
                    Description = "Wintergroene, sterk vertakte struik of kleine boom met leerachtige, lancetvormige, donkergroene bladeren. Bloeit in de zomer met opvallende trompetvormige bloemen in schermvormige trossen. Kleur varieert van wit tot roze, rood of soms geel. Zeer populair als sierstruik in mediterrane tuinen, parken en openbaar groen. Kan in een milde winter buiten overleven, maar is bij strenge vorst niet volledig winterhard.",
                    Etymology = "De geslachtsnaam 'Nerium' komt van de Griekse plantnaam en 'oleander' is een oude naam; de precieze oorsprong is onzeker.",
                    ImagePath = diskLocationImages + "Nerium_oleander_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Passiflora caerulea",
                    CommonName = "Blue Passionflower",
                    AlternativeNames = "Blue passionflower, Hardy passionflower, Passiebloem",
                    Family = "Passifloraceae",
                    Genus = "Passiflora",
                    Species = "caerulea",
                    Description = "Sterke, winterharde klimplant met diep ingesneden, handvormige bladeren en opvallende blauw-witte bloemen met een paars kroonkrans. Bloeit van zomer tot herfst. Vormt eetbare maar weinig smakelijke oranje bessen als de zomer warm genoeg is. Geschikt voor pergola's, muren en schuttingen.",
                    Etymology = "De geslachtsnaam 'Passiflora' verwijst naar 'passie' (passieflora) vanwege de symboliek in de bloem; 'caerulea' betekent blauwachtig.",
                    ImagePath = diskLocationImages + "Passiflora_caerulea_Base01.png",
                    PlantType = PlantType.Climber,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Hydrangea serrata",
                    CommonName = "Mountain hydrangea, Tellar",
                    AlternativeNames = "Mountain hydrangea, Tea of heaven, Serrata hydrangea",
                    Family = "Hydrangeaceae",
                    Genus = "Hydrangea",
                    Species = "serrata",
                    Description = "Compacte bladverliezende struik met ovaal tot eirond, gekarteld blad. Vormt prachtige, vlakke schermen met fijne, blauw, lavendel, roze tot rood gekleurde lacecap bloemen vanaf vroege zomer tot de herfst, afhankelijk van de zuurgraad van de grond. Goed winterhard, geschikt voor kleine tuinen, borders en potten. Van oorsprong uit de bergbossen van Japan en Korea. Bekend als 'tea of heaven', bladeren worden daar soms gebruikt voor zoete thee.",
                    Etymology = "De geslachtsnaam 'Hydrangea' komt van Grieks 'hydor' (water) en 'angeion' (container); 'serrata' betekent 'gezaagd' verwijzend naar het blad.",
                    ImagePath = diskLocationImages + "Hydrangea_serrata_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    Species = "glutinosa",
                    Description = "Middelgrote bladverliezende boom tot 30 meter hoog met een kegelvormige kroon en vaak meerdere stammen. De jonge twijgen en knoppen zijn kleverig, volwassen schors is donker en diep gegroefd. Ovaalronde, donkergroene bladeren met een getande rand; blijft opvallend lang groen in het najaar. Mannelijke (hangende) en vrouwelijke (staande, kegelvormige) katjes verschijnen vóór het uitlopen van het blad in het vroege voorjaar. Vruchtjes lijken op kleine kegeltjes die de hele winter aan de boom blijven. Bekend als pioniersboom op natte standplaatsen (oevers, moeras, beekdalen), waar hij o.a. stikstof bindende wortelknobbeltjes vormt.",
                    Etymology = "De geslachtsnaam 'Alnus' is een klassieke Latijnse naam voor els; 'glutinosa' verwijst naar kleverige knoppen.",
                    ImagePath = diskLocationImages + "Alnus_glutinosa_Base01.png",
                    PlantType = PlantType.Tree,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Prunus armeniaca",
                    CommonName = "Apricot, Armenian Plum",
                    AlternativeNames = "Apricot, Armenian plum",
                    Family = "Rosaceae",
                    Genus = "Prunus",
                    Species = "armeniaca",
                    Description = "Kleine tot middelgrote, bladverliezende boom met een ronde, brede kroon en glanzend donkergroen, eirond blad met fijn gezaagde rand. Bloeit in het vroege voorjaar vóór het uitlopen van het blad met geurende witte tot roze bloemen. Later verschijnen eetbare, geel-oranje, soms rood getinte vruchten met sappig, zoet vlees. De boom is gevoelig voor vroege vorst vanwege de vroege bloei. Geschikt voor voedselbossen en (sier)tuinen met zonnige, beschutte standplaats.",
                    Etymology = "De geslachtsnaam 'Prunus' is Latijn voor pruim; 'armeniaca' verwijst naar Armenië, waar de abrikoos was verspreid.",
                    ImagePath = diskLocationImages + "Prunus_armeniaca_Base01.png",
                    PlantType = PlantType.Tree,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Bear’s breeches, Oyster plant, Italian acanthus",
                    Family = "Acanthaceae",
                    Genus = "Acanthus",
                    Species = "mollis",
                    ...
                    Etymology = "De geslachtsnaam 'Acanthus' is afgeleid van het Griekse 'akantha', wat 'doorn' betekent, vanwege de stekelige bladeren; 'mollis' betekent 'zacht'.",
                    ImagePath = diskLocationImages + "Acanthus_mollis_Base01.png",
                    PlantType = PlantType.HerbaceousPerennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Hemerocallis",
                    CommonName = "Daylily",
                    AlternativeNames = "Daylily, Daglelie",
                    Family = "Asphodelaceae",
                    Genus = "Hemerocallis",
                    Species = "", // Overkoepelende soort, vul specifieke soort/cultivar in indien gewenst
                    Description = "Sterk groeiende, bladverliezende vaste plant met breed uitlopende pollen van langwerpige, grasachtige bladeren. Bloeit van de vroege zomer tot in de herfst met opvallende, trechter- of stervormige bloemen in vele kleuren. Elke bloem bloeit slechts één dag, maar de bloei zet door dankzij voortdurende knopvorming. Zeer betrouwbaar, weinig eisend en zeer geschikt voor border, oever, talud en grote pot.",
                    Etymology = "De geslachtsnaam 'Hemerocallis' komt van het Grieks 'hemera' (dag) en 'kallos' (schoonheid), verwijzend naar de bloei van één dag.",
                    ImagePath = diskLocationImages + "Hemerocallis_Base01.png",
                    PlantType = PlantType.HerbaceousPerennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Common purslane, Little hogweed, Verdolaga, Portulak",
                    Family = "Portulacaceae",
                    Genus = "Portulaca",
                    Species = "oleracea",
                    ...
                    Etymology = "De geslachtsnaam 'Portulaca' is vermoedelijk afgeleid van het Latijn 'portula' (kleine poort), mogelijk vanwege de manier waarop de vrucht opent; 'oleracea' betekent 'groenteachtig' of 'eetbaar'.",
                    ImagePath = diskLocationImages + "Portulaca_oleracea_Base01.png",
                    PlantType = PlantType.Succulent,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    LocalName = "Calibrachoa 'Jaune'",
                    CommonName = "Yellow Million Bells, Mini-petunia",
                    AlternativeNames = "Million bells, Mini-petunia",
                    Family = "Solanaceae",
                    Genus = "Calibrachoa",
                    Species = "", // Cultivar/hybride, soort kan leeg blijven voor cultivars
                    Description = "Compacte, eenjarige of kortlevende vaste plant met overhangende, licht rankende groeiwijze. Deze rijkbloeiende 'mini-petunia' produceert van het late voorjaar tot de eerste vorst talloze kleine, trompetvormige, helder gele bloemen. Door zijn standvastige bloei en compacte groei ideaal voor hangmanden, potten, balkonbakken en randen. Bladeren elliptisch tot ovaal, frisgroen, glad. Trekt bijen en vlinders.",
                    Etymology = "De geslachtsnaam 'Calibrachoa' is een samenstelling van 'Calibra' (verwijzend naar Calibrachoa) en 'Petunia', vanwege de relatie tussen de planten; 'Jaune' is Frans voor geel.",
                    ImagePath = diskLocationImages + "Calibrachoa_Jaune_Base01.png",
                    PlantType = PlantType.HerbaceousPerennial, // Vaak als eenjarige gekweekt in NL
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "St John's wort, Hertshooi, Perforate St John's-wort",
                    Family = "Hypericaceae",
                    Genus = "Hypericum",
                    Species = "perforatum",
                    ...
                    Etymology = "De geslachtsnaam 'Hypericum' komt van het Grieks 'hyper' (over) en 'eikon' (beeld), wat verwijst naar de plant die boven het gras uitsteekt; 'perforatum' betekent 'doorboord', duidend op de kleine gaatjes in het blad.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Wax begonia, Fibrous begonia, Semperflorens begonia",
                    Family = "Begoniaceae",
                    Genus = "Begonia",
                    ...
                    Etymology = "De geslachtsnaam 'Begonia' is genoemd naar Michel Bégon, een Franse plantenverzamelaar; '× semperflorens-cultorum' betekent 'altijd bloeiend', verwijst naar de langdurige bloei.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Spindle tree, European spindle, Kardinaalsmuts",
                    Family = "Celastraceae",
                    Genus = "Euonymus",
                    Species = "europaeus",
                    ...
                    Etymology = "De geslachtsnaam 'Euonymus' komt van het Grieks 'eu' (goed) en 'onymos' (naam), waarschijnlijk vanwege de fraaie vruchten of symbolische betekenis; 'europaeus' betekent 'van Europa'.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Pink jasmine, Winter jasmine, Pink Toscane jasmine",
                    Family = "Oleaceae",
                    Genus = "Jasminum",
                    Species = "polyanthum",
                    ...
                    Etymology = "De geslachtsnaam 'Jasminum' komt van het Perzische woord voor geurige bloem; 'polyanthum' betekent 'met veel bloemen'.",
               ...
               // Witte Jasmijn
                new Plant
                {
                    ...
                    AlternativeNames = "Star jasmine, Confederate jasmine, Chinese jasmine",
                    Family = "Apocynaceae",
                    ...
                    Etymology = "De geslachtsnaam 'Trachelospermum' is afgeleid van het Grieks voor 'kraag' en 'zaad', verwijzend naar de vorm van de zaden; 'jasminoides' betekent 'lijken op jasmijn'.",
                ...
                new Plant
                {
                    ...
                    LocalName = "Veronica",
                    CommonName = "Dogtong",
                    AlternativeNames = "Spiked speedwell, Blue veronica, Dogtongue",
                    Family = "Plantaginaceae",
                    Genus = "Veronica",
                    Species = "spicata",
                    ...
                    Etymology = "De geslachtsnaam 'Veronica' is waarschijnlijk genoemd naar de heilige Veronica uit de katholieke traditie; 'spicata' betekent 'aarvormig', verwijzend naar de bloemwijze.",
                ...
                new Plant
                {
                    ...
                    Etymology = "De geslachtsnaam 'Nerium' is een oude naam voor oleander; 'oleander' komt waarschijnlijk van het Griekse 'oníron' (droom) of Arabische oorsprong.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Stokes’ aster, Cornflower aster",
                    Family = "Asteraceae",
                    Genus = "Stokesia",
                    Species = "laevis",
                    ...
                    Etymology = "De geslachtsnaam 'Stokesia' is genoemd naar Jonathan Stokes, een Engelse botanicus; 'laevis' betekent 'glad' in het Latijn.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "New York aster, Michaelmas daisy, Nieuw-Belgische aster",
                    Family = "Asteraceae",
                    ...
                    Etymology = "De geslachtsnaam 'Symphyotrichum' is afgeleid van het Grieks voor 'samengevoegde bloemen' (symphysis) en Aster (ster), vanwege de bloemvorm; 'novi-belgii' verwijst naar New York (Nieuw-België).",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Annabelle hydrangea, Smooth hydrangea",
                    Family = "Hydrangeaceae",
                    Genus = "Hydrangea",
                    ...
                    Etymology = "De geslachtsnaam 'Hydrangea' komt van het Grieks 'hydor' (water) en 'angeion' (container), verwijzing naar de grote bloemschermen; 'arborescens' betekent 'struikachtig'.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Oxeye daisy, Margriet, White daisy",
                    Family = "Asteraceae",
                    Genus = "Leucanthemum",
                    Species = "vulgare",
                    ...
                    Etymology = "De geslachtsnaam 'Leucanthemum' betekent ‘witte bloem’ in het Grieks; 'vulgare' betekent ‘gewoon’ of ‘algemeen voorkomend’.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Florist’s chrysanthemum, Garden mum",
                    Family = "Asteraceae",
                    Genus = "Chrysanthemum",
                    Species = "× morifolium",
                    ...
                    Etymology = "De geslachtsnaam 'Chrysanthemum' is afkomstig van het Grieks: 'chrysos' (goud) en 'anthemon' (bloem); '× morifolium' betekent ‘met bladeren vergelijkbaar met witte melkdistel’.",
                ...
                new Plant
                {
                    ...
                    LocalName = "Laurier",
                    CommonName = "Laurel",
                    AlternativeNames = "Bay laurel, True laurel, Sweet bay",
                    Family = "Lauraceae",
                    Genus = "Laurus",
                    Species = "nobilis",
                    ...
                    Etymology = "De geslachtsnaam 'Laurus' verwijst naar laurier, afgeleid van het Latijn; 'nobilis' betekent ‘nobel’ of ‘eerbiedwaardig’.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Esparto grass, Needle grass, Alpha grass",
                    Family = "Poaceae",
                    Genus = "Stipa",
                    Species = "tenacissima",
                    ...
                    Etymology = "De geslachtsnaam 'Stipa' komt uit het Latijn en betekent ‘stro’; 'tenacissima' betekent ‘zeer taai’ of ‘hardnekkig’.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Plume celosia, Silver cockscomb, Woolflower",
                    ...
                    Etymology = "De geslachtsnaam 'Celosia' komt van het Griekse ‘kelos’, wat 'woekering' betekent, vanwege de pluimvormige bloei; 'argentea' betekent ‘zilverkleurig’.",
                ...
                new Plant
                {
                    ...
                    CommonName = "Buddleja",
                    AlternativeNames = "Butterfly bush, Summer lilac, Vlinderstruik",
                    ...
                    Etymology = "De naam 'Buddleja' is vernoemd naar Abraham Buddle, een Engelse botanicus; 'davidii' eert de Franse plantkundige Armand David.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Hemp-nettle, Common hemp-nettle",
                    Family = "Lamiaceae",
                    Genus = "Galeopsis",
                    Species = "tetrahit",
                    ...
                    Etymology = "De geslachtsnaam 'Galeopsis' is afgeleid van het Griekse woord 'galeos' (haai), vanwege de vorm van de bloem; 'tetrahit' betekent ‘vierkantig’.",
                ...
                new Plant
                {
                    ...
                    LocalName = "Coleus",
                    CommonName = "Coleus",
                    AlternativeNames = "Coleus, Paintnettle, Solenostemon",
                    Family = "Lamiaceae",
                    Genus = "Plectranthus",
                    ...
                    Etymology = "De geslachtsnaam 'Plectranthus' komt uit het Grieks: 'plektron' (kam, punt) en 'anthos' (bloem); 'scutellarioides' betekent ‘lijken op Scutellaria’.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Tickseed, Calliopsis, Meisjesogen",
                    Family = "Asteraceae",
                    Genus = "Coreopsis",
                    Species = "tinctoria",
                    ...
                    Etymology = "De geslachtsnaam 'Coreopsis' komt van het Grieks ‘koris’ (wants) en ‘opsis’ (zicht), verwijzend naar de vorm van de zaadhoofden; 'tinctoria' betekent ‘geverfd’ of ‘kleurend’.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Climbing hydrangea, Klimhortensia",
                    Family = "Hydrangeaceae",
                    Genus = "Hydrangea",
                    ...
                    Etymology = "De geslachtsnaam 'Hydrangea' bestaat uit het Grieks ‘hydor’ (water) en ‘angeion’ (container), verwijzend naar de waterbehoefte; 'anomala' betekent ‘abnormaal’, ‘afwijkend’; 'subsp. petiolaris' wijst op het gesteelde blad.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Common rhododendron, Pontic rhododendron, Rhododendron",
                    Family = "Ericaceae",
                    Genus = "Rhododendron",
                    Species = "ponticum",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Limelight hydrangea, Panicle hydrangea, Pluimhortensia",
                    Family = "Hydrangeaceae",
                    Genus = "Hydrangea",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Field maple, Veldesdoorn, Hedge maple",
                    Family = "Sapindaceae",
                    Genus = "Acer",
                    Species = "campestre",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Common bugle, Carpet bugle, Kruipend zenegroen",
                    Family = "Lamiaceae",
                    Genus = "Ajuga",
                    Species = "reptans",
                    Description = "Een laagblijvende, wintergroene bodembedekker met glanzende bladeren en blauwe bloemtrossen in het voorjaar.",
                    Etymology = "De geslachtsnaam 'Ajuga' betekent wellicht 'niet nuttig' (Latijn); 'reptans' betekent 'kruipend'.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Baby’s-breath, Gipskruid",
                    Family = "Caryophyllaceae",
                    Genus = "Gypsophila",
                    Species = "paniculata",
                    Description = "Een meerjarige plant met fijne, luchtige witte of roze bloemtrossen, populair als snijbloem.",
                    Etymology = "De naam 'Gypsophila' betekent letterlijk 'liefhebber van gips' (Grieks); verwijzend naar groeiplaatsen.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Ribbon Falls sedge, Japanese sedge",
                    Family = "Cyperaceae",
                    Genus = "Carex",
                    ...
                    Etymology = "De naam 'Carex' is zegge; 'oshimensis' verwijst naar het eiland Ōshima; 'Ribbon Falls' beschrijft bladval.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Silver cockscomb, Plume celosia, Woolflower",
                    Family = "Amaranthaceae",
                    Genus = "Celosia",
                    Species = "argentea",
                    ...
                    Etymology = "De geslachtsnaam 'Celosia' komt van het Griekse 'kelos' (brandwond), verwijzend naar de vlamvormige bloemen; 'argentea' betekent zilverachtig.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Privet, Oval-leaved privet, Japanese privet",
                    Family = "Oleaceae",
                    Genus = "Ligustrum",
                    Species = "ovalifolium",
                    ...
                    Etymology = "De naam 'Ligustrum' betekent privet (Latijn), mogelijk afgeleid van 'ligare' (binden).",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Japanese anemone, Windflower",
                    Family = "Ranunculaceae",
                    Genus = "Anemone",
                    Species = "hupehensis",
                    Description = "Een vaste plant met sierlijke, grote bloemen in roze of wit die bloeit in de late zomer en herfst.",
                    Etymology = "De geslachtsnaam 'Anemone' betekent wind waarmee bloemen vaak bewegen (Grieks); 'hupehensis' verwijst naar Hubei, China.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Busy Lizzie, Impatiens, Vlijtig liesje",
                    ...
                    Etymology = "De Nederlandse naam ‘Vlijtig liesje’ is volks; ‘Impatiens’ betekent ongeduldig (Latijn), verwijzend naar snel openspringende zaaddozen; ‘walleriana’ genoemd naar Waller.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Pot marigold, Goudsbloem, Common marigold",
                    Family = "Asteraceae",
                    Genus = "Calendula",
                    Species = "officinalis",
                    ...
                    Etymology = "De geslachtsnaam 'Calendula' komt van Latijn 'calendae' (eerste dag van de maand), verwijzend naar lange bloeiperiode; 'officinalis' betekent medicinaal.",
                ...
                new Plant
                {
                    ...
                    AlternativeNames = "Vervain, Common vervain, IJzerhard",
                    Family = "Verbenaceae",
                    Genus = "Verbena",
                    Species = "officinalis",
                ...
                //// Viburnum tinus (Laurierbladige Sneeuwbal)
                new Plant
                {
                    Id = 96,
                    LocalName = "Laurierbladige Sneeuwbal",
                    CommonName = "Viburnum tinus",
                    AlternativeNames = "Laurustinus, Evergreen viburnum, Laurier viburnum",
                    Family = "Adoxaceae",
                    Genus = "Viburnum",
                    Species = "tinus",
                    Description = "Wintergroene heester met glanzend, donkergroen blad en dichte witte tot lichtroze bloemen in het voorjaar, gevolgd door blauwzwarte bessen. Populair als haag, solitair en voor wintergroene structuur.",
                    Etymology = "De naam Viburnum is een klassieke Latijnse plantennaam; tinus verwijst naar de oorspronkelijke naam voor deze soort.",
                    ImagePath = diskLocationImages + "Viburnum_tinus_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                    Color = "Donkergroen blad; wit/roze bloemen; blauwzwarte bessen",
                    IsFlowering = true,
                    IsEvergreen = true,
                    IsPoisonous = false, // Bessen licht giftig; niet als ernstig toxisch beschouwd
                    Shape = "Bossige, compacte, ronde tot opgaande struik",
                    FullGrownHeight = 300, // tot 2-3 meter
                    FullGrownWidth = 250,
                    Light = "Volle zon tot halfschaduw; beste bloei in zon",
                    Water = "Regelmatig bij aanplant; eenmaal gevestigd redelijk droogtetolerant",
                    Soil = "Goed doorlatende, voedzame, kalkrijke tot neutrale grond; verdraagt klei, zand en leem",
                    FertilizationMethod = "Jaarlijkse bemesting in het voorjaar met organische meststof",
                    TrimmingInstructions = "Na de bloei licht snoeien voor vorm; kan als haag stevig gesnoeid worden",
                    TrimmingPeriod = "Direct na bloei of vroege zomer",
                    TemperatureRangeMinimum = -12,
                    TemperatureRangeMaximum = 35
                },

                // Monarda Hybrid (Monarda × didyma) (Bergamot / Siermonarda / Bergamotplant)
                new Plant
                {
                    Id = 97,
                    LocalName = "Bergamotplant",
                    CommonName = "Monarda Hybrid",
                    AlternativeNames = "Bee balm, Siermonarda, Bergamot, Oswego tea",
                    Family = "Lamiaceae",
                    Genus = "Monarda",
                    Species = "× didyma",
                    Description = "Vaste plant met aromatisch blad en opvallende, bloemachtige bloeiaren in rood, roze, paars of wit. Trekt bijen, vlinders en is geliefd voor de siertuin en als snijbloem.",
                    Etymology = "De geslachtsnaam Monarda is genoemd naar botanist Nicolás Monardes; 'didyma' betekent tweeslachtig, hybrid betekent gecultiveerde kruising.",
                    ImagePath = diskLocationImages + "Monarda_didyma_Base01.png",
                    PlantType = PlantType.Perennial,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = true, // Blad en bloemen worden soms gebruikt als thee/kruid
                    Color = "Rood, roze, paars, wit bloemen; groen aromatisch blad",
                    IsFlowering = true,
                    IsEvergreen = false,
                    IsPoisonous = false,
                    Shape = "Opgaande, bossige plant met kransvormige, pluizige bloemen",
                    FullGrownHeight = 90,
                    FullGrownWidth = 60,
                    Light = "Volle zon tot lichte schaduw; beste bloei in zon",
                    Water = "Licht vochtig, niet nat; verdraagt korte droogte",
                    Soil = "Voedzame, humusrijke, goed doorlatende, liefst licht zure grond",
                    FertilizationMethod = "Jaarlijks lichte bemesting in het voorjaar",
                    TrimmingInstructions = "Na de bloei terugsnoeien tot 10 cm boven de grond voor verjonging",
                    TrimmingPeriod = "Late zomer of na de bloei",
                    TemperatureRangeMinimum = -20,
                    TemperatureRangeMaximum = 30
                },

                // Hebe (bloeiende variëteit, bv. Hebe 'Andersonii', 'Blue Gem', etc.)
                new Plant
                {
                    Id = 98,
                    LocalName = "Bloeiende Hebe",
                    CommonName = "Hebe",
                    AlternativeNames = "Shrubby veronica, Struikveronica, Hebe bush",
                    Family = "Plantaginaceae",
                    Genus = "Hebe",
                    Species = "", // Vul indien specifieke soort/cultivar anders "" voor siergroepen
                    Description = "Groenblijvende, compacte struiken met rechtopstaande stengels, leerachtig blad en bloei in witte, roze, paarse, lavendel of blauwe trossen van de late lente tot de herfst. Geschikt voor randen, potten en rotstuinen.",
                    Etymology = "De naam Hebe is genoemd naar de Griekse godin van de jeugd; veel soorten vallen nu ook onder Veronica.",
                    ImagePath = diskLocationImages + "Hebe_bloeiend_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                    Color = "Wit, roze, paars, lavendel, blauw bloemen; groen blad",
                    IsFlowering = true,
                    IsEvergreen = true,
                    IsPoisonous = false,
                    Shape = "Compacte, bossige struik met opgaande bloemaren",
                    FullGrownHeight = 80, // afhankelijk soort/cultivar: 30–120 cm mogelijk
                    FullGrownWidth = 80,
                    Light = "Volle zon tot lichte schaduw; beste bloei bij veel licht",
                    Water = "Regelmatig, houd grond licht vochtig; niet nat",
                    Soil = "Goed doorlatend, liefst neutraal tot licht zuur, humusrijk",
                    FertilizationMethod = "Lente bemesting met uitgebalanceerde meststof",
                    TrimmingInstructions = "Na de bloei licht terugsnoeien voor compacte groei; dode bloemen verwijderen",
                ...
                // Lagerstroemia indica (Pruikboom / Crepe Myrtle)
                new Plant
                {
                    Id = 122,
                    LocalName = "Pruikboom",
                    CommonName = "Crepe Myrtle",
                    AlternativeNames = "Lagerstroemia indica",
                    Family = "Lythraceae",
                    Genus = "Lagerstroemia",
                    Species = "indica",
                    Description = "Bladverliezende struik of kleine boom met opvallende, gerimpelde bloemen in kleuren variërend van roze tot paars en wit. Bloeit in de zomer tot herfst en is populair vanwege zijn lange bloeiperiode en decoratieve schors.",
                    Etymology = "Naam Lagerstroemia komt van Magnus von Lagerstroem, een Zweedse botanicus.",
                    ImagePath = diskLocationImages + "Lagerstroemia_indica_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                    Color = "Roze, paars, wit",
                    IsFlowering = true,
                    IsEvergreen = false,
                    IsPoisonous = false,
                    Shape = "Opgaande struik of kleine boom",
                    FullGrownHeight = 400,
                    FullGrownWidth = 300,
                    Light = "Volle zon",
                    Water = "Matig; verdraagt droge periodes na vestiging",
                    Soil = "Goed doorlatend, licht zuur tot neutraal",
                    FertilizationMethod = "Lente bemesten met organische meststof",
                    TrimmingInstructions = "Snoei in late winter of vroege lente om de vorm te behouden",
                    TrimmingPeriod = "Late winter tot vroege lente",
                    TemperatureRangeMinimum = -10,
                    TemperatureRangeMaximum = 40
                },

                // Caryopteris (Blauwbaard)
                new Plant
                {
                    Id = 123,
                    LocalName = "Blauwbaard",
                    CommonName = "Bluebeard",
                    AlternativeNames = "Caryopteris x clandonensis",
                    Family = "Lamiaceae",
                    Genus = "Caryopteris",
                    Species = "x clandonensis",
                    Description = "Compacte, bladverliezende struik met aromatisch blad en opvallende blauwe bloemen die bloeien van late zomer tot herfst. Wordt vaak gebruikt als borderplant en trekt vlinders aan.",
                    Etymology = "De naam Caryopteris betekent 'met gevleugelde blaadjes'.",
                    ImagePath = diskLocationImages + "Caryopteris_blauwbaard_Base01.png",
                    PlantType = PlantType.Shrub,
                    PlantClassification = PlantClassification.Angiosperms,
                    PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                    IsEatable = false,
                    ...
                    IsEvergreen = false,
                    IsPoisonous = false,
                    Shape = "Compacte, opgaande struik",
                    FullGrownHeight = 100,
                    FullGrownWidth = 120,
                    Light = "Volle zon tot halfschaduw",
                    Water = "Gemiddeld; geen natte voeten",
                    Soil = "Goed doorlatend, licht zuur tot neutraal",
                    FertilizationMethod = "Lente bemesten met universele meststof",
                    TrimmingInstructions = "Terugknippen in het voorjaar om nieuwe groei te bevorderen",
                    TrimmingPeriod = "Vroege lente",
                    TemperatureRangeMinimum = -20,
                    TemperatureRangeMaximum = 35
                },
            ...
            {
                Id = 124,
                LocalName = "Montereycipres",
                CommonName = "Monterey Cypress",
                AlternativeNames = "Cupressus macrocarpa",
                Family = "Cupressaceae",
                Genus = "Cupressus",
                Species = "macrocarpa",
                Description = "Grootschalige, langzame groeiende conifeer met dichte, blauwgroene naalden. Vaak gebruikt als windkering in kustgebieden.",
                Etymology = "Macrocarpa betekent 'grote vruchten', verwijzend naar de grote zaden van de boom.",
                ImagePath = diskLocationImages + "Cupressus_macrocarpa_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Gymnosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Pinophyta"),
                ...
                IsEvergreen = true,
                IsPoisonous = false,
                Shape = "Piramidale boomvorm",
                FullGrownHeight = 2000,
                FullGrownWidth = 800,
                Light = "Volle zon",
                Water = "Gemiddeld tot droog",
                Soil = "Goed doorlatend zandgrond",
                FertilizationMethod = "Lente bemesting met compost",
                TrimmingInstructions = "Snoeien van uitdunnende takken voor vormbehoud",
                TrimmingPeriod = "Late winter",
                TemperatureRangeMinimum = -10,
                TemperatureRangeMaximum = 30
            },
            ...
            new Plant
            {
                ...
                LocalName = "Skimmia",
                CommonName = "Skimmia",
                AlternativeNames = "Skimmia japonica",
                Family = "Rutaceae",
                Genus = "Skimmia",
                Species = "japonica",
                Description = "Kleine, groenblijvende struik met dichte bladeren en bolvormige, witte tot roze bloemen in het voorjaar. Winterharde tuinplant.",
                Etymology = "Skimmia is een traditionele familienaam",
                ImagePath = diskLocationImages + "Skimmia_japonica_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = true,
                IsPoisonous = false,
                Shape = "Bolvormige struik",
                FullGrownHeight = 100,
                FullGrownWidth = 120,
                Light = "Halfschaduw tot schaduw",
                Water = "Vochtig, goed doorlatend",
                Soil = "Zuur tot neutraal",
                FertilizationMethod = "Lente bemesting met organische mest",
                TrimmingInstructions = "Lichte snoei na bloei",
                TrimmingPeriod = "Laat voorjaar",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 25
            },
            ...
            {
                Id = 126,
                LocalName = "Pluimspirea",
                CommonName = "Astilbe",
                AlternativeNames = "Astilbe spp.",
                Family = "Saxifragaceae",
                Genus = "Astilbe",
                Species = "spp.",
                Description = "Vaak gebruikt in schaduwrijke tuinen voor de kleurrijke pluimen van bloemen in wit, roze en rood. Blad is geveerd en decoratief.",
                Etymology = "Astilbe betekent 'zonder stijl'",
                ImagePath = diskLocationImages + "Astilbe_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                Soil = "Zuur, humusrijk",
                FertilizationMethod = "Lente bemesting met gebalanceerde meststof",
                TrimmingInstructions = "Afknippen van uitgebloeide bloemen",
                TrimmingPeriod = "Zomer",
                TemperatureRangeMinimum = -20,
                TemperatureRangeMaximum = 30
            },

            // Aster (Purple flowers type)
            new Plant
            {
                Id = 127,
                LocalName = "Aster",
                CommonName = "Aster (paarse bloemen)",
                AlternativeNames = "Aster spp.",
                Family = "Asteraceae",
                Genus = "Aster",
                Species = "spp.",
                Description = "Vaste plant met kleurrijke paarse bloemen in het najaar. Aantrekkelijk voor vlinders en honingbijen.",
                Etymology = "Aster betekent 'ster', verwijzend naar de bloemvorm",
                ImagePath = diskLocationImages + "Aster_purple_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Bossige vaste plant",
                FullGrownHeight = 80,
                FullGrownWidth = 75,
                Light = "Volle zon tot halfschaduw",
                Water = "Gemiddeld",
                Soil = "Goed doorlatend, licht zuur",
                FertilizationMethod = "Lente bemesting met bloemmeststof",
                TrimmingInstructions = "Terugknippen om nieuwe groei te stimuleren",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -25,
                TemperatureRangeMaximum = 30
            },
            ...
            new Plant
            {
                ...
                AlternativeNames = "Helleborus spp.",
                Family = "Ranunculaceae",
                Genus = "Helleborus",
                Species = "spp.",
                Description = "Vaste plant met winterharde, groenblijvende bladeren en kleurige bloemen in winter tot vroege lente.",
                Etymology = "Helleborus betekent 'giftige plant' - voorzichtigheid geboden",
                ImagePath = diskLocationImages + "Helleborus_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                Color = "Wit, roze, groen",
                IsFlowering = true,
                IsEvergreen = true,
                IsPoisonous = true,
                Shape = "Polvormige vaste plant",
                ...
                FullGrownWidth = 50,
                Light = "Halfschaduw tot schaduw",
                Water = "Gemiddeld, niet te nat",
                Soil = "Zuur tot neutraal, goed doorlatend",
                FertilizationMethod = "Lente bemesting met compost",
                TrimmingInstructions = "Verwijderen van oude bladeren",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -20,
                TemperatureRangeMaximum = 25
            },
            ...
            {
                Id = 129,
                LocalName = "Ballonbloem",
                CommonName = "Platycodon",
                AlternativeNames = "Platycodon grandiflorus",
                Family = "Campanulaceae",
                Genus = "Platycodon",
                Species = "grandiflorus",
                Description = "Vaste plant met ballonvormige bloemknoppen die blauw openen, zeer decoratief en winterhard.",
                Etymology = "Platycodon betekent 'platte kelk', verwijzend naar de bloemvorm.",
                ImagePath = diskLocationImages + "Platycodon_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Opgaande vaste plant",
                FullGrownHeight = 60,
                FullGrownWidth = 40,
                Light = "Volle zon tot halfschaduw",
                Water = "Gemiddeld",
                Soil = "Goed doorlatend, humusrijk",
                FertilizationMethod = "Lente bemesting met universele mest",
                TrimmingInstructions = "Afknippen na bloei",
                TrimmingPeriod = "Zomer",
                TemperatureRangeMinimum = -20,
                TemperatureRangeMaximum = 30
            },
            ...
            {
                Id = 130,
                LocalName = "Chinese Waaierpalm",
                CommonName = "Trachycarpus fortunei",
                AlternativeNames = "Windmill Palm",
                Family = "Arecaceae",
                Genus = "Trachycarpus",
                Species = "fortunei",
                Description = "Kleine, winterharde palm met waaierachtige bladeren, geliefd als tuinplant in gematigde klimaten.",
                Etymology = "Trachycarpus betekent 'houterige hand', verwijzend naar de bladsteel.",
                ImagePath = diskLocationImages + "Trachycarpus_fortunei_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = true,
                IsPoisonous = false,
                Shape = "Kleine palmboom",
                FullGrownHeight = 1200,
                FullGrownWidth = 600,
                Light = "Volle zon",
                Water = "Gemiddeld",
                Soil = "Goed doorlatend",
                FertilizationMethod = "Lente bemesting met palmmest",
                TrimmingInstructions = "Verwijderen van dode bladeren",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 35
            },

            // Trachycarpus wagerianus (expanded detail assumed under same genus, example)
            new Plant
            {
                Id = 131,
                LocalName = "Wager Palm",
                CommonName = "Trachycarpus wagerianus",
                AlternativeNames = "",
                Family = "Arecaceae",
                Genus = "Trachycarpus",
                Species = "wagerianus",
                Description = "Soortgelijke kleine palmboom met gelijkaardige eigenschappen als Trachycarpus fortunei, maar iets minder winterhard.",
                Etymology = "Verwijzend naar botanicus Wager",
                ImagePath = diskLocationImages + "Trachycarpus_wagerianus_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Gaura",
                CommonName = "Gaura",
                AlternativeNames = "Gaura lindheimeri",
                Family = "Onagraceae",
                Genus = "Gaura",
                Species = "lindheimeri",
                Description = "Sierlijke vaste plant met luchtige witte tot roze bloemen, bloeit lang in de zomer.",
                Etymology = "Gaura betekent 'stralend' of 'mooi'",
                ImagePath = diskLocationImages + "Gaura_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            new Plant
            {
                ...
                LocalName = "Ereprijs",
                CommonName = "Veronica",
                AlternativeNames = "Veronica spp.",
                Family = "Plantaginaceae",
                Genus = "Veronica",
                Species = "spp.",
                Description = "Vaste planten of bodembedekkers met kleine blaadjes en talloze bloemen in blauw, paars, wit of roze.",
                Etymology = "Veronica is afgeleid van een Latijnse vrouwelijke naam",
                ImagePath = diskLocationImages + "Veronica_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                Color = "Blauw, Paars, Wit, Roze",
                IsFlowering = true,
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Bossige vaste plant of bodembedekker",
                FullGrownHeight = 40,
                FullGrownWidth = 60,
                Light = "Volle zon tot halfschaduw",
                Water = "Gemiddeld",
                Soil = "Goed doorlatend",
                FertilizationMethod = "Lente bemesting met bloemmeststof",
                TrimmingInstructions = "Terugknippen na bloei",
                TrimmingPeriod = "Zomer",
                TemperatureRangeMinimum = -20,
                TemperatureRangeMaximum = 30
            },
            ...
            {
                Id = 134,
                LocalName = "Sarcococca",
                CommonName = "Sweet Box",
                AlternativeNames = "Sarcococca spp.",
                Family = "Buxaceae",
                Genus = "Sarcococca",
                Species = "spp.",
                Description = "Groenblijvende struik met glanzende bladeren en geurige witte bloemen in wintertijd.",
                Etymology = "Sarcococca betekent 'vleesachtige bessen'",
                ImagePath = diskLocationImages + "Sarcococca_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = true,
                IsPoisonous = false,
                Shape = "Compacte struik",
                FullGrownHeight = 80,
                FullGrownWidth = 100,
                Light = "Halfschaduw",
                Water = "Gemiddeld",
                Soil = "Vochtig, goed doorlatend",
                FertilizationMethod = "Lente bemesting met organische mest",
                TrimmingInstructions = "Licht snoeien na bloei",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 25
            },

            // Euonymus japonica (Japanse kardinaalsmuts)
            new Plant
            {
                Id = 135,
                LocalName = "Japanse kardinaalsmuts",
                CommonName = "Euonymus japonica",
                AlternativeNames = "Euonymus japonicus",
                Family = "Celastraceae",
                Genus = "Euonymus",
                Species = "japonicus",
                Description = "Groenblijvende struik met glanzende, leerachtige bladeren en kleine bloemen. Populair als haagplant.",
                Etymology = "Euonymus betekent 'mooie naam' of 'welsprekend', verwijzend naar de sierwaarde.",
                ImagePath = diskLocationImages + "Euonymus_japonica_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = true,
                IsPoisonous = false,
                Shape = "Struik met dicht blad",
                FullGrownHeight = 200,
                FullGrownWidth = 150,
                Light = "Volle zon tot halfschaduw",
                Water = "Gemiddeld",
                Soil = "Goed doorlatend, neutraal tot licht zuur",
                FertilizationMethod = "Lente bemesting met universele meststof",
                TrimmingInstructions = "Terugknippen voor vormbehoud",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 30
            },
            ...
            {
                Id = 136,
                LocalName = "Montbretia",
                CommonName = "Crocosmia",
                AlternativeNames = "Crocosmia spp.",
                Family = "Iridaceae",
                Genus = "Crocosmia",
                Species = "spp.",
                Description = "Meerjarige plant met lange bloemstelen en opvallende oranje tot rode bloemen, geliefd in zomer- en snijbloemen.",
                Etymology = "Crocosmia betekent 'saffraangeur', verwijzend naar de geur van sommige soorten.",
                ImagePath = diskLocationImages + "Crocosmia_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                FullGrownWidth = 50,
                Light = "Volle zon",
                Water = "Gemiddeld, goed doorlatend",
                Soil = "Vochtig, humusrijk",
                FertilizationMethod = "Lente bemesting met bloemmeststof",
                TrimmingInstructions = "Verwijderen van uitgebloeide bloemen",
                TrimmingPeriod = "Zomer",
                TemperatureRangeMinimum = -20,
                TemperatureRangeMaximum = 30
            },
            ...
            new Plant
            {
                Id = 137,
                LocalName = "Leucothoe",
                CommonName = "Leucothoe",
                AlternativeNames = "Leucothoe spp.",
                Family = "Ericaceae",
                Genus = "Leucothoe",
                Species = "spp.",
                Description = "Groenblijvende, bossige struiken met glanzende bladeren en trossen hangende witte bloemen.",
                Etymology = "Leucothoe betekent 'witte bloem'.",
                ImagePath = diskLocationImages + "Leucothoe_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = true,
                IsPoisonous = false,
                Shape = "Bossige struik",
                FullGrownHeight = 150,
                FullGrownWidth = 120,
                Light = "Halfschaduw",
                Water = "Vochtig, goed doorlatend",
                Soil = "Zuur tot neutraal",
                FertilizationMethod = "Lente bemesting met ericaceous meststof",
                TrimmingInstructions = "Lichte snoei na bloei",
                TrimmingPeriod = "Zomer",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 25
            ...
            {
                Id = 138,
                LocalName = "Vingerplant",
                CommonName = "Fatsia japonica",
                AlternativeNames = "",
                Family = "Araliaceae",
                Genus = "Fatsia",
                Species = "japonica",
                Description = "Groenblijvende plant met grote, glanzende handvormige bladeren, geschikt voor schaduwrijke plekken.",
                Etymology = "Fatsia is de oude Japanse naam voor de plant.",
                ImagePath = diskLocationImages + "Fatsia_japonica_Base01.png",
                PlantType = PlantType.Shrub,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                Soil = "Goed doorlatend, neutraal tot licht zuur",
                FertilizationMethod = "Lente bemesting met organische meststof",
                TrimmingInstructions = "Snoeien om vorm te behouden",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -10,
                TemperatureRangeMaximum = 30
            },
            ...
            {
                Id = 139,
                LocalName = "Duizendknoop",
                CommonName = "Persicaria",
                AlternativeNames = "Persicaria spp.",
                Family = "Polygonaceae",
                Genus = "Persicaria",
                Species = "spp.",
                Description = "Vaste planten of eenjarige kruiden met lange bloeiwijze en vaak kleurrijke bloemen.",
                Etymology = "Persicaria betekent 'perzikachtig', vanwege de vorm van sommige bladeren.",
                ImagePath = diskLocationImages + "Persicaria_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            {
                Id = 140,
                LocalName = "Kamperfoelie",
                CommonName = "Lonicera",
                AlternativeNames = "Lonicera spp.",
                Family = "Caprifoliaceae",
                Genus = "Lonicera",
                Species = "spp.",
                Description = "Klimplant of struik met geurige bloemen en bessen, aantrekkelijk voor vogels en insecten.",
                Etymology = "Lonicera genoemd naar Adam Lonitzer, Duitse botanicus.",
                ImagePath = diskLocationImages + "Kamperfoelie_Base01.png",
                PlantType = PlantType.Climber,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                Soil = "Goed doorlatend",
                FertilizationMethod = "Lente bemesting met universele meststof",
                TrimmingInstructions = "Snoeien na bloei voor vorm en gezondheid",
                TrimmingPeriod = "Zomer",
                TemperatureRangeMinimum = -20,
                TemperatureRangeMaximum = 30
            },
            ...
            new Plant
            {
                ...
                LocalName = "Lariks",
                CommonName = "Lariks",
                AlternativeNames = "Larix decidua",
                Family = "Pinaceae",
                Genus = "Larix",
                Species = "decidua",
                Description = "Naaldboom die in de winter zijn naalden verliest, vaak gebruikt als sierboom en windkering.",
                Etymology = "Larix betekent 'helder' of 'licht', verwijzend naar het hout.",
                ImagePath = diskLocationImages + "Larix_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Gymnosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Pinophyta"),
                IsEatable = false,
                ...
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Piramidale boom",
                FullGrownHeight = 2500,
                FullGrownWidth = 1200,
                Light = "Volle zon",
                Water = "Gemiddeld",
                Soil = "Vochtig, goed doorlatend",
                FertilizationMethod = "Lente bemesting met compost",
                TrimmingInstructions = "Af en toe dunnen van takken",
                TrimmingPeriod = "Late winter",
                TemperatureRangeMinimum = -40,
                TemperatureRangeMaximum = 30
            },
            ...
            {
                Id = 142,
                LocalName = "Blauwe regen",
                CommonName = "Wisteria",
                AlternativeNames = "Wisteria spp.",
                Family = "Fabaceae",
                Genus = "Wisteria",
                Species = "spp.",
                Description = "Klimplant met spectaculaire bloemtrossen in paars, blauw of wit, zeer geschikt voor pergola's.",
                Etymology = "Wisteria genoemd naar botanicus Caspar Wistar.",
                ImagePath = diskLocationImages + "Wisteria_Base01.png",
                PlantType = PlantType.Climber,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                Color = "Paars, Blauw, Wit",
                IsFlowering = true,
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Klimplant met lange trossen",
                FullGrownHeight = 800,
                FullGrownWidth = 500,
                Light = "Volle zon",
                Water = "Gemiddeld",
                Soil = "Goed doorlatend",
                FertilizationMethod = "Lente bemesting met bloemmeststof",
                TrimmingInstructions = "Snoeien in zomer en winter voor bloei",
                TrimmingPeriod = "Zomer en winter",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 30
            },

            // Leverkruid (Verbascum)
            new Plant
            {
                Id = 143,
                LocalName = "Leverkruid",
                CommonName = "Verbascum",
                AlternativeNames = "Verbascum spp.",
                Family = "Scrophulariaceae",
                Genus = "Verbascum",
                Species = "spp.",
                Description = "Eenjarige of vaste plant met grote, donzige bladeren en hoge bloemstelen met gele bloemen.",
                Etymology = "Verbascum komt mogelijk van het Latijn voor genezend.",
                ImagePath = diskLocationImages + "Verbascum_Leverkruid_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            {
                Id = 144,
                LocalName = "Russische salie",
                CommonName = "Perovskia",
                AlternativeNames = "Perovskia atriplicifolia",
                Family = "Lamiaceae",
                Genus = "Perovskia",
                Species = "atriplicifolia",
                Description = "Grote vaste plant met zilvergrijs blad en lange aren met paarse bloemen, heerlijk geurend.",
                Etymology = "Genoemd naar de botanicus Perovskij.",
                ImagePath = diskLocationImages + "Perovskia_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Uitgestrekte vaste plant",
                FullGrownHeight = 120,
                FullGrownWidth = 100,
                Light = "Volle zon",
                Water = "Droogtebestendig",
                Soil = "Goed doorlatend",
                FertilizationMethod = "Lente bemesting met organische mest",
                TrimmingInstructions = "Terugknippen in voorjaar",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -15,
                TemperatureRangeMaximum = 35
            },
            ...
            new Plant
            {
                ...
                LocalName = "Cyclamen",
                CommonName = "Cyclamen",
                AlternativeNames = "Cyclamen spp.",
                Family = "Primulaceae",
                Genus = "Cyclamen",
                Species = "spp.",
                Description = "Knolvormige vaste planten met geaderde bladeren en sierlijke bloemen in diverse kleuren vooral in herfst en winter.",
                Etymology = "Cyclamen betekent 'kleine ring' wat de bloemvorm beschrijft.",
                ImagePath = diskLocationImages + "Cyclamen_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Kleine, compacte vaste plant",
                FullGrownHeight = 25,
                FullGrownWidth = 20,
                Light = "Halfschaduw",
                Water = "Gemiddeld, goed doorlatend",
                Soil = "Humusrijk, licht zuur",
                FertilizationMethod = "Lente bemesting met organische mest",
                TrimmingInstructions = "Verwijderen van verwelkte bloemen",
                TrimmingPeriod = "Na bloei",
                TemperatureRangeMinimum = -10,
                TemperatureRangeMaximum = 25
            },

            // Agapanthus (Lelie van de Nijl)
            new Plant
            {
                Id = 146,
                LocalName = "Lelie van de Nijl",
                CommonName = "Agapanthus",
                AlternativeNames = "Agapanthus africanus",
                Family = "Amaryllidaceae",
                Genus = "Agapanthus",
                Species = "africanus",
                Description = "Krachtige vaste plant met grote blauwpaarse bloemschermen, populair in de zomerborders.",
                Etymology = "Agapanthus betekent 'liefde bloem'.",
                ImagePath = diskLocationImages + "Agapanthus_Base01.png",
                PlantType = PlantType.Perennial,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
            ...
            // Katalpa (Reuzensering)
            new Plant
            {
                Id = 147,
                LocalName = "Reuzensering",
                CommonName = "Katalpa",
                AlternativeNames = "Katalpa spp.",
                Family = "Bignoniaceae",
                Genus = "Katalpa",
                Species = "spp.",
                Description = "Snelle groeier met grote, hartvormige bladeren en opvallende witte bloemen in trossen.",
                Etymology = "Naam komt van een Indiaanse term voor boom.",
                ImagePath = diskLocationImages + "Katalpa_Base01.png",
                PlantType = PlantType.Tree,
                PlantClassification = PlantClassification.Angiosperms,
                PhylumInfo = (Phylum)GetPhylumByName(phyla, "Magnoliophyta"),
                IsEatable = false,
                ...
                IsEvergreen = false,
                IsPoisonous = false,
                Shape = "Snelgroeiende boom",
                FullGrownHeight = 1800,
                FullGrownWidth = 1000,
                Light = "Volle zon",
                Water = "Gemiddeld",
                Soil = "Voedingsrijke, goed doorlatende grond",
                FertilizationMethod = "Lente bemesting met compost",
                TrimmingInstructions = "Snoeien om vorm te behouden",
                TrimmingPeriod = "Vroege lente",
                TemperatureRangeMinimum = -25,
